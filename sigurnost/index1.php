...
# crypt() koji koristi DES ili neki drugi algoritam - Blowfish, MD5
...
# Prilikom logovanja uzmete ono što je unio korisnik, dodate salt, 
# ponovno hašujete i onda upoređejete sa onim što je u bazi.
...
#echo password_hash("MojPassword!", PASSWORD_ARGON2ID) . "<hr>";
echo "<hr>";
